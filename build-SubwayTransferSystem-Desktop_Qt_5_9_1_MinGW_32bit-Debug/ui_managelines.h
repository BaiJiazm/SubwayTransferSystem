...
public:
    ...
    void setupUi(QDialog *ManageLines)
    {
        ...
        doubleSpinBoxLatitude->setMaximum(32);
    ...
    void retranslateUi(QDialog *ManageLines)
    {
        ...
        label_23->setText(QApplication::translate("ManageLines", "<html><head/><body><p>\346\234\211\346\225\210\350\214\203\345\233\264:</p><p>min [ 120.0 , 30.0 ]</p><p>max [ 122.0 , 32.0 ]</p><p><br/></p></body></html>", Q_NULLPTR));
